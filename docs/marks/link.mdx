import {Dot, Geo, Link, Replot, Sphere, Text, treeLink, treeNode} from "@dave-hillier/replot/react";
import * as d3 from "d3";
import income from "../data/income-gender.ts";
import metros from "../data/metros.ts";
import {useLand} from "../data/world.ts";

export const xy = {x1: -122.4194, y1: 37.7749, x2: 2.3522, y2: 48.8566};
export const gods = ["Chaos/Gaia/Mountains", "Chaos/Gaia/Pontus", "Chaos/Gaia/Uranus", "Chaos/Eros", "Chaos/Erebus", "Chaos/Tartarus"];
...
<Replot grid inset={10} x={{
  ...
  <Link data={metros} x1="POP_1980" y1="R90_10_1980" x2="POP_2015" y2="R90_10_2015" stroke={(d) => d.R90_10_2015 - d.R90_10_1980} markerEnd="arrow" />
  <Text data={metros} x="POP_2015" y="R90_10_2015" filter="highlight" text="nyt_display" fill="currentColor" stroke="var(--vp-c-bg)" dy={-8} />
</Replot>
...
<Replot axis={null} height={120} inset={20} insetRight={120}>
  <Link data={gods} {...treeLink({stroke: "node:internal"})} />
  <Dot data={gods} {...treeNode({fill: "node:internal"})} />
  <Text data={gods} {...treeNode({text: "node:name", stroke: "var(--vp-c-bg)", fill: "currentColor", dx: 6})} />
</Replot>
...
<Replot projection="equal-earth">
  <Sphere />
  <Geo data={useLand()} fill="currentColor" fillOpacity={0.3} />
  <Link data={{length: 1}} curve="linear" stroke="red" {...xy} />
  <Link data={{length: 1}} markerStart="dot" markerEnd="arrow" strokeWidth={1.5} {...xy} />
</Replot>
...
<Replot aspectRatio={1} marginRight={40} x={{
  ...
  <Link data={[0.6, 0.7, 0.8, 0.9, 1]} x1={0} y1={0} x2={102000} y2={(k) => 102000 * k} strokeOpacity={(k) => k === 1 ? 1 : 0.2} />
  <Text data={[0.6, 0.7, 0.8, 0.9, 1]} x={102000} y={(k) => 102000 * k} text={((f) => (k) => k === 1 ? "Equal" : f(k - 1))(d3.format("+.0%"))} textAnchor="start" dx={6} />
  <Dot data={income} x="m" y="f" />
</Replot>
...
```jsx
<Link data={inequality} x1="POP_1980" y1="R90_10_1980" x2="POP_2015" y2="R90_10_2015" />
```

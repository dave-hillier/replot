import {Dot, DodgeY, Frame, Image, Replot, RuleX, RuleY} from "@dave-hillier/replot/react";
import penguins from "../data/penguins.ts";
import presidents from "../data/us-president-favorability.ts";
...
<Replot inset={20} x={{label: "First inauguration date"}} y={{grid: true, label: "Net favorability (%)", tickFormat: "+f"}}>
  <RuleY data={[0]} />
  <Image data={presidents} x="First Inauguration Date" y={(d) => d["Very Favorable %"] + d["Somewhat Favorable %"] - d["Very Unfavorable %"] - d["Somewhat Unfavorable %"]} src="Portrait URL" width={40} title="Name" />
</Replot>
...
<Replot x={{inset: 20, label: "First inauguration date"}} y={{insetTop: 4, grid: true, label: "Any opinion (%)", tickFormat: "+f"}}>
  <RuleY data={[0]} />
  <Image data={presidents} x="First Inauguration Date" y={(d) => d["Very Favorable %"] + d["Somewhat Favorable %"] + d["Very Unfavorable %"] + d["Somewhat Unfavorable %"]} src="Portrait URL" r={20} preserveAspectRatio="xMidYMin slice" title="Name" />
</Replot>
...
<Replot inset={20} height={280}>
  <DodgeY>
    <Image data={presidents} x="First Inauguration Date" r={20 /* clip to a circle */} preserveAspectRatio="xMidYMin slice" src="Portrait URL" title="Name" />
  </DodgeY>
</Replot>
...
<Replot aspectRatio={1} grid x={{label: "Favorable opinion (%)"}} y={{label: "Unfavorable opinion (%)"}}>
  <RuleY data={[0]} />
  <RuleX data={[0]} />
  <Image data={presidents} x={(d) => d["Very Favorable %"] + d["Somewhat Favorable %"]} y={(d) => d["Very Unfavorable %"] + d["Somewhat Unfavorable %"]} src="Portrait URL" title="Name" />
</Replot>
...
<Replot margin={30} inset={10} grid style={{
    padding: "10px",
    color: "black",
  ...
  <Frame />
  <Dot data={penguins} x="culmen_length_mm" y="culmen_depth_mm" fill="white" stroke="black" />
</Replot>
...
```jsx
<Image data={presidents} x="inauguration" y="favorability" src="portrait" />
```
